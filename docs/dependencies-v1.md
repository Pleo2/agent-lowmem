...
## Phase 5 Local Release Candidate Gate — 2026-09-05
...
The complete local gates were:

```bash
scripts/check-release.sh 0.1.0 /path/to/checksum-verified/cargo-audit dist /external/release-evidence.txt
scripts/audit-publication.sh /path/to/checksum-verified/gitleaks /external/publication-evidence.txt
```
